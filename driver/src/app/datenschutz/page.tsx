...
export default function DatenschutzPage() {
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="bg-primary px-5 pt-12 pb-4 flex items-center gap-3">
        <Link href="/login">
        ...
        <h1 className="text-lg font-bold text-white">Datenschutzerklärung</h1>
      </div>
      ...
      <div className="px-5 pt-6 max-w-2xl mx-auto space-y-6">
        ...
        <section>
          ...
          <ul className="text-sm text-gray-700 leading-relaxed mt-2 list-disc pl-5 space-y-1">
            ...
            <li><strong>GPS-Tracking als Fahrer:</strong> Wenn Sie als Fahrer online sind, wird Ihre Position alle 3 Sekunden erfasst und an den Server übermittelt, um Kunden ein Live-Tracking der Lieferung zu ermöglichen und verfügbare Fahrer in der Nähe zuzuordnen.</li>
            <li><strong>Buchungsdaten:</strong> Abhol- und Zieladressen, Preise, Zeitstempel</li>
            <li><strong>Fotos:</strong> Abholfotos, Ablieferungsfotos sowie Profilfotos, die Sie hochladen</li>
            <li><strong>Fahrzeugdaten:</strong> Art des Fahrzeugs (Fahrrad oder Lastenrad)</li>
